# Shows how to use transactions. Actually the use of transactions
# for this case is unnecessary if cascade destroy relationship is relied on and where
# transactions will be automatically created on the update and save to span
# both objects
# @author Chris Loftus
class ImageService
