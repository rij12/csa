...
class BroadcastService
  ...
  # Code taken and modified by cwl from Kieran Dunbar's SE31520 assignment solution 2016-17
  def self.via_notification_feed(broadcast)
    # We broadcast to the notifications channel providing the HTML data
    # generated by the partial notifications/_notification.html.erb
    # Notice how this partial is also used by the _notifications.html.erb partial.
    # This is an example of DRY in action.
    ActionCable.server.broadcast(
      'notifications',
      ApplicationController.renderer.render(partial: 'notifications/notification',
                                            locals: {notification: broadcast})
    )
